...
INSERT INTO IMS_Books (Title, Publisher, ISBN, Format, BookLanguage, Lexile) VALUES
('The Hobbit (The Lord of the Rings)','Clarion Books; Young Reader ed. edition (August 15, 2002)','978-0618260300','Paperback','English',1000),
('Treasure Island','Independently published (March 11, 2020)','979-8623553805','Paperback','English',760),
('Fahrenheit 451','Simon & Schuster; Reissue edition (January 10, 2012)','978-1451673319','Paperback','English',890),
('Fairy Tale','Scribner (June 6, 2023)','978-1668002193','Paperback','English',NULL)
;
